...
class Plugin(object):
    ...
    def _parse_args(self):
        ...
        # self.args.framework_config={"server_name": "13.59.141.92", "server_port": "4000", "server_protocol": "http"}
    ...
    def _print_diagnostic(self):
        ...
        with diagnostics_timer:
            ...
            sys.stdout.flush()
            matric_config = self.get_metrics_config(metrics, defaults )
    ...
    def get_metrics_config (self, metrics, defaults):
            for metric in metrics:
